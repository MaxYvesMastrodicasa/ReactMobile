    ...
    useEffect(() => {
      ...
      async function getProfileCar() {
        try {
          ...
          const { data, error, status } = await supabase
            .from("voiture")
            .select(`utilisateur_id, marque, modele, annee, couleur, plaque_immatriculation`)
      ...
      async function updateProfileCar({
        ...
        try {
          ...
          const { error } = await supabase.from("voiture").upsert(updates);
    ...
    return(
      ...
      <View style={[styles.verticallySpaced, styles.mt20]}>
          <Button
            ...
            onPress={() =>
              updateProfileCar({marque, modele, annee, couleur,plaque_immatriculation})
            }
            disabled={loading}
          />
        </View>
